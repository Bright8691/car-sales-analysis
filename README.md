...
-	Residual = Actual Price - Predicted Price. 
  1. 0 Line (Red Dashed): Perfect predictions.
  2. Above 0: Underestimation (the car actually sold for more than predicted).
  3. Below 0: Overestimation (the car sold for less than predicted).
